...
def _summarize_config(metrics: dict[str, float]) -> tuple[str, ...]:
    ...
    summary = [
        ...
        f"coarse_loss_weight={config.get('coarse_loss_weight', 'n/a')}",
        f"coarse_blur_kernel={config.get('coarse_blur_kernel', 'n/a')}",
        f"coarse_blur_sigma={config.get('coarse_blur_sigma', 'n/a')}",
        f"refine_blocks={config.get('refine_blocks', 'n/a')}",
        f"refine_channels_mult={config.get('refine_channels_mult', 'n/a')}",
